...
%{ 
Let's think about a better composition for the world structure:
- type of game
- size of population
- #/% of cooperators
- #/% of defectors
...
--> can we initialize the payoffs here, or should they be initialized in
the _init_function
